...
| 文件 | 作用 |
| --- | --- |
| 	ables/Supplementary_Tables_V17.xlsx | 当前补充表格工作簿 |
| 	ables/Table_S2.xlsx | 独立 Table S2（DEAS + JP PSI） |
| 	ables/Table_S2_Differential_AS.csv | 7,434 条 DEAS；48 条通过 \|ΔPSI\| ≥ 0.2 且 P ≤ 0.01 |
...
igures/2026-08-20_PDAC_mainfigure_v3.pptx 与当前正文一致（Figure 2d scheme A）。v4 留作对照；图注尚未锁死。
